...
function Report(_ref) {
  ...
  return _react2.default.createElement(
    ...
    !!processedWarnings.length && _react2.default.createElement(_MessageGroup.MessageGroup, {
      type: 'warning',
      title: _('There are ') + processedWarnings.length + _(' warning(s)'),
      expandText: _('Warning details'),
      messages: processedWarnings
    }),
    !!validTableFiles.length && _react2.default.createElement(_MessageGroup.MessageGroup, {
      type: 'success',
      title: _('There are ') + validTableFiles.length + _(' valid table(s)'),
      expandText: _('Success details'),
...
function marked(src, opt, callback) {
  ...
  try {
    ...
    if ((opt || marked.defaults).silent) {
      return '<p>_(An error occured: )</p><pre>'
...
module.exports = {
	...
	"errors": {
		...
		"enumerable-constraint": {
			...
			"context": "body",
			"weight": 7,
			"message": _("The value {value} in row {row_number} and column {column_number} does not conform to the given enumeration: {constraint}"),
			"description": _("This field value should be equal to one of the values in the enumeration constraint.\n\n How it could be resolved:\n - If this value is not correct, update the value.\n - If value is correct, then remove or refine the `enum` constraint in the schema.\n - If this error should be ignored disable `enumerable-constraint` check in {validator}.")
		},
		"minimum-constraint": {
